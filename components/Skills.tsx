  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        {/* Academic Skills */}
        <div className="royal-card p-10 rounded-[2.5rem] bg-zinc-950/40 border-t-2 border-t-[#D4AF37]/50">
          <h3 className="royal-text text-2xl font-bold text-white mb-10 flex items-center gap-4">
            ...
            {softSkills.map((skill) => (
              <div key={skill} className="group flex items-center justify-between p-5 bg-white/5 border border-white/10 rounded-2xl hover:bg-[#D4AF37]/5 hover:border-[#D4AF37]/40 transition-all">
                ...
                <div className="h-1 w-20 bg-zinc-800 rounded-full overflow-hidden">
                  <div className="h-full bg-gradient-to-r from-[#D4AF37] to-transparent w-full"></div>
                </div>
              </div>
            ))}
          </div>
